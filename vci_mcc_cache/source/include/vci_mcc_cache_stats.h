...
#ifndef SOCLIB_CABA_VCI_MCC_CACHE_STATS_H
#define SOCLIB_CABA_VCI_MCC_CACHE_STATS_H
#include <inttypes.h>
namespace soclib {
namespace caba {
	typedef struct {
		...
		uint64_t dcache_tlb_hit;
		uint64_t dcache_tlb_miss;
		uint64_t dcache_tlb_nack;
		uint64_t dcache_tlb_delay;
		uint64_t dcache_tlb_delay_chunck;
		uint64_t icache_tlb_hit;
		uint64_t icache_tlb_miss;
		uint64_t icache_tlb_nack;
		uint64_t icache_tlb_delay;
		uint64_t icache_tlb_delay_chunck;
		uint64_t idelay;
